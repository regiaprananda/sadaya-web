          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            <div className="flex gap-8 mb-10">
              <div className="w-[120px] h-[120px] bg-white rounded-full p-2 shadow-2xl border-4 border-[#CFA96F] overflow-hidden transform transition-all duration-500 hover:scale-110 hover:rotate-3">
                <img src="./Sadaya-Logo-v3.jpeg" alt="Logo SADAYA" className="w-full h-full object-cover rounded-full bg-white" onError={(e)=>{e.target.onerror = null; e.target.src="[https://placehold.co/200x200/ECE1C9/8D5B30?text=S](https://placehold.co/200x200/ECE1C9/8D5B30?text=S)"}} />
              </div>
              <div className="w-[120px] h-[120px] bg-white rounded-full p-2 shadow-2xl border-4 border-[#CFA96F] overflow-hidden transform transition-all duration-500 hover:scale-110 hover:-rotate-3">
                <img src="./kabinet-logo-v3.jpeg" alt="Logo Kabinet" className="w-full h-full object-contain rounded-full bg-white" onError={(e)=>{e.target.onerror = null; e.target.src="[https://placehold.co/200x200/ECE1C9/8D5B30?text=K](https://placehold.co/200x200/ECE1C9/8D5B30?text=K)"}} />
              </div>
            </div>
